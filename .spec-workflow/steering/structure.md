...
│       │   └── infrastructure/        # FloorPlanRepositoryImpl, RoomMapper（MyBatis）
...
| MyBatis Mapper（interface） | PascalCase + `Mapper.kt` | `RoomMapper.kt` |
| MyBatis Mapper XML | PascalCase + `Mapper.xml` | `RoomMapper.xml` |
