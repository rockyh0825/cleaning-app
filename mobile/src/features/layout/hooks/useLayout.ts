...
export function buildFloorPlanQuery(userId: string, repository: Pick<LayoutRepository, 'getFloorPlan'>) {
    return {
...
export function useLayout(userId: string, repository: LayoutRepository) {
