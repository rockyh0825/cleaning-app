...
type HistoryQueryKey = readonly ['cleaning-records', { userId: string; partId?: string }];
...
export function useCleaningHistory(
    ...
    const historyQuery = useQuery(buildCleaningHistoryQuery(userId, params, repository));
